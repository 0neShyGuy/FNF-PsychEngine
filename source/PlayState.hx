...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'Garfield':
				...
				var comicBG = new BGSprite('GARFIELDbg', 128.333333333333, -61.6666666666666, 1, 1);
				add(comicBG);
				add(boyfriendGroup);

				var comicFG = new BGSprite('GARFIELDfg', -1468.33333333333, -571.666666666667, 1, 1);
				add(comicFG);
				add(dadGroup);
		}
		...
		healthBar = new FlxBar(healthBarBG.x - 4, healthBarBG.y - 4, BOTTOM_TO_TOP, Std.int(healthBarBG.width / 20), Std.int(healthBarBG.height * 8), this,
			'health', 0, 2);
		...
		if (isStoryMode && !seenCutscene)
		{
			switch (daSong)
			{
				case 'fight-or-flight':
					PlayState.SONG.splashSkin = "BloodSplash";
	...
	override public function update(elapsed:Float)
	{
		...
		lime.app.Application.current.window.title = "Monday Morning Mischief | " + curSong + " : " + CoolUtil.difficultyString();
